...
export default function AddEquipment() {
  ...
  return (
    <Fade triggerOnce>
      <div className="max-w-4xl mx-auto px-4 lg:px-6 my-6 lg:my-10">
        <Card className="p-4 lg:p-6 bg-white dark:bg-gray-900 shadow-lg">
          <Typography
            variant="h4"
            className="text-center mb-6 text-gray-800 dark:text-gray-100 text-2xl lg:text-3xl"
          >
            Add New Equipment
          </Typography>

          <form onSubmit={handleAddEquipment} className="grid gap-4 lg:gap-6">
            {/* Basic Information */}
            <div className="col-span-full">
              <Typography
                variant="h6"
                className="mb-3 lg:mb-4 text-gray-700 dark:text-gray-300 text-lg"
              >
                Basic Information
              </Typography>
            ...
            <Button
              type="submit"
              className="mt-4 lg:mt-6 bg-red-600 hover:bg-red-700 dark:bg-red-500 dark:hover:bg-red-600"
            >
              Add Equipment
            </Button>
          </form>
